                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 category-product-item">
                        <div class="category-product-card">
                            ...
                            <div class="category-product-image-container">
                                <img src="<?= $product->getImagen() ?>" class="category-product-image" alt="<?= $product->getNombre() ?>">
                            </div>
                            ...
                            <div class="category-product-content">
                                ...
                                <ul class="category-product-meta">
                                    ...
                                    <li class="category-product-meta-item">
                                        ...
                                        <span class="category-meta-value"><?= $product->getStock() > 0 ? 'En stock' : 'Agotado' ?></span>
                                    </li>
                                    <li class="category-product-meta-item">
                                ...
                                <div class="category-product-actions">
                                    <?php if ($product->getStock() > 0): ?>
                                        <button class="category-btn-product category-btn-add-cart" data-product="<?= $product->getIdProducto() ?>">
                                            <i class="fas fa-shopping-cart"></i> Añadir al carrito
                                        </button>
                                    <?php else: ?>
                                        <button class="category-btn-product category-btn-notify" data-product="<?= $product->getIdProducto() ?>">
                                            <i class="fas fa-bell"></i> Notificarme
                                        </button>
                                    <?php endif; ?>
                                    <a href="/product?id=<?= $product->getIdProducto() ?>" class="category-btn-product category-btn-details">
                                        Detalles
                                    </a>
                                </div>
                            </div>
